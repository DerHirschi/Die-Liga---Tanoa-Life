...
switch (_state) do
{
    ...
    {
        _shop SVAR["locked",true,true];
       
		[_shop,_robber,_action,-1] remoteExec ["life_fnc_shopState",RCLIENT];
    ...
    sleep 300; 
	[_shop,_robber,_action,0] remoteExec ["life_fnc_shopState",RCLIENT];
    _shop SVAR["locked",false,true];
