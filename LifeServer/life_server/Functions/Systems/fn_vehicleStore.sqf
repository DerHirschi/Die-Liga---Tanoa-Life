...
*/
private["_vehicle","_impound","_repcount","_vInfo","_tuv","_vInfo","_plate","_uid","_query","_unit","_dam_ar"];
...
if(count _repcount isEqualTo 0) then {_repcount = 0;_tuv = 0;}else{_tuv = SEL(_repcount,0);_repcount = SEL(_repcount,1);};
