...
class liga_HB6 {
	...
	class controlsBackground {
		...
		{
		idc = -1;
		text = "textures\LigaBuch\Tanoa_Buch_5.jpg";
			x = -0.25;
			y = -0.1;
			w = 1.5;
			h = 1.035;
	...
	class controls {	
			...
			idc = -1;
			text = "";
			onButtonClick = "closeDialog 0; createDialog ""liga_HB6a""; playSound ""HBuch""; ";
			...
			idc = -1;
			text = "";
			onButtonClick = "closeDialog 0; createDialog ""liga_HB5""; playSound ""HBuch""; ";
			x = - 0.177;
			y = 0.895 - (1 / 25);
			w = 0.09;
			h = (1 / 25);
