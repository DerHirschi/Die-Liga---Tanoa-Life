...
class Liga_RscScrollBar
{
	color[] = {0,0,0,0.1};
	colorActive[] = {0,0,0,0.1};
	colorDisabled[] = {0,0,0,0};
	thumb = "#(argb,8,8,3)color(1,1,1,0.7)";
	arrowEmpty = "#(argb,8,8,3)color(1,1,1,0)";
	arrowFull = "#(argb,8,8,3)color(1,1,1,0.2)";
	border = "#(argb,8,8,3)color(1,1,1,0.8)";
	shadow = 0;
	scrollSpeed = 0.06;
	width = 0;
	height = 0;
...
class Life_RscControlsGroup {
	...
	class LigaHScrollBar : Liga_RscScrollBar
	{
		height = 0.023;
	};	
...
class Liga_RscListNBox_S
{
	...
	*/
    ...
    colorText[] = {1,1,1,1};
    colorDisabled[] = {0.95,0.95,0.95,0.7};
    colorScrollbar[] = {0.95,0.95,0.95,0.6};
    colorSelect[] = {1,1,1,0.9};
    colorSelect2[] = {1,1,1,0.6};
...
class Liga_RscButtonMenu_Pic : Life_RscShortcutButton {
	idc = -1;
	type = CT_ACTIVETEXT;
	style = ST_LEFT;
	default = 0;
...
class Liga_RscButtonMenuUns : Life_RscShortcutButton {
	idc = -1;
	type = 16;
	style = "0x02 + 0xC0";
	default = 0;
	...
	colorBackground2[] = {0.0,0.0,0.0,0};
	color[] = {1,1,1,0};
	colorFocused[] = {0,0,0,0};
	color2[] = {0,0,0,0};
	colorText[] = {1,1,1,0};
...
class Liga_RscButtonMenu : Life_RscShortcutButton {
	idc = -1;
	type = 16;
	style = "0x02 + 0xC0";
	default = 0;
...
class Liga_RscCheckbox {
	...
	colorText[] = {1, 1, 1, 1};
	color[] = {0, 0, 0, 0};
	colorBackground[] = {0.2, 0.2, 0.23, 0.4};
	colorTextSelect[] = {0.2, 0.2, 0.23, 0.4};
	colorSelectedBg[] = {0.2, 0.2, 0.23, 0.6};
	colorSelect[] = {0, 0, 0, 0.6};
	colorTextDisable[] = {0.4, 0.4, 0.4, 0.4};
	colorDisable[] = {0.4, 0.4, 0.4, 0.4};
	font = "PuristaMedium";
	sizeEx = "(			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
	rows = 1;
	5ns = 1;
...
class Life_RscListBox 
{
    ...
    colorPicture[] = {1,1,1,1};						 //Black Icon Fix Arma Update 1.38
    colorPictureSelected[] = {1,1,1,1};		 //Black Icon Fix Arma Update 1.38
    colorPictureDisabled[] = {1,1,1,1};		 //Black Icon Fix Arma Update 1.38
	arrowFull = "\A3\ui_f\data\gui\cfg\scrollbar\arrowFull_ca.paa";
	arrowEmpty = "\A3\ui_f\data\gui\cfg\scrollbar\arrowEmpty_ca.paa";
	wholeHeight = 0.45;
	rowHeight = 0.04;
...
class Liga_RscListBox 
{
	...
	colorBackground[] = {0.28,0.28,0.28,0.28};
	colorSelect2[] = {1, 1, 1, 1};
	colorSelectBackground[] = {0, 0.0, 0.0, 0.5};
	colorSelectBackground2[] = {0, 0, 0, 0.5};
	colorScrollbar[] = {0.6, 0.6, 0.6, 0};         
    colorPicture[] = {1,1,1,0};						 //Black Icon Fix Arma Update 1.38
    colorPictureSelected[] = {1,1,1,1};		 //Black Icon Fix Arma Update 1.38
    colorPictureDisabled[] = {1,1,1,1};		 //Black Icon Fix Arma Update 1.38
	arrowFull = "\A3\ui_f\data\gui\cfg\scrollbar\arrowFull_ca.paa";
	arrowEmpty = "\A3\ui_f\data\gui\cfg\scrollbar\arrowEmpty_ca.paa";
...
class Liga_RscListBox_U
{
	...
	colorSelect2[] = {1, 1, 1, 1};
	colorSelectBackground[] =  {0.0,0.0,0.0,0.8};
	colorSelectBackground2[] =  {0.0,0.0,0.0,0.8};
	colorScrollbar[] = {0.6, 0.6, 0.6, 0};         
    colorPicture[] = {1,1,1,1};						 //Black Icon Fix Arma Update 1.38
    colorPictureSelected[] = {1,1,1,1};		 //Black Icon Fix Arma Update 1.38
    colorPictureDisabled[] = {1,1,1,1};		 //Black Icon Fix Arma Update 1.38
...
class Liga_RscListBox_S
{
	...
	colorBackground[] = {0.28,0.28,0.28,0.28};	
	colorSelect2[] = {0.8, 0.8, 0.8, 0.8};
	colorSelectBackground[] = {0.1, 0.1, 0.1, 1};
	colorSelectBackground2[] = {0, 0, 0, 0};
	colorScrollbar[] = {0.6, 0.6, 0.6, 0.7};          
    colorPicture[] = {1,1,1,0.9};						 //Black Icon Fix Arma Update 1.38
    colorPictureSelected[] = {1,1,1,1};		 //Black Icon Fix Arma Update 1.38
    colorPictureDisabled[] = {1,1,1,1};		 //Black Icon Fix Arma Update 1.38
	arrowFull = "\A3\ui_f\data\gui\cfg\scrollbar\arrowFull_ca.paa";
	arrowEmpty = "\A3\ui_f\data\gui\cfg\scrollbar\arrowEmpty_ca.paa";
...
class Liga_RscMapControl 
{
	access = 0;
	type = 101;
	idc = 51;
	style = 48;
	colorBackground[] = {0.969,0.957,0.949,0.2};
	colorOutside[] = {0,0,0,0.2};
	colorText[] = {0,0,0,0.4};
	font = "TahomaB";
	sizeEx = 0.04;
	colorSea[] = {0.467,0.631,0.851,0.05};
	colorForest[] = {0.624,0.78,0.388,0.05};
	colorRocks[] = {0,0,0,0.15};
	colorCountlines[] = {0.572,0.354,0.188,0.15};
	colorMainCountlines[] = {0.572,0.354,0.188,0.3};
	colorCountlinesWater[] = {0.491,0.577,0.702,0.1};
	colorMainCountlinesWater[] = {0.491,0.577,0.702,0.2};
	colorForestBorder[] = {0,0,0,0};
	colorRocksBorder[] = {0,0,0,0};
	colorPowerLines[] = {0.1,0.1,0.1,1};
	colorRailWay[] = {0.8,0.2,0,1};
