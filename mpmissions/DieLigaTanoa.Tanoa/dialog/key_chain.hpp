class Life_key_management {
	...
	class controls {
		...
		class GiveKey : Life_RscButtonMenu {
			...
			onButtonClick = "[] spawn life_fnc_keyGive";
			x = -0.04 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH));
			y = 0.69;
			w = (6.25 / 40);
			h = (1 / 25);
		};
		class GiveKeyPerm : Life_RscButtonMenu {
			idc = 2704;
			text = "verschenken";
			colorBackground[] = {0, 0.25, 0, 0.9};
			onButtonClick = "[] spawn life_fnc_keySchenk     ";
			x = 0.32 + (1 / 25) + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH));
			y = 0.69;
			w = (6.25 / 40);
			h = (1 / 25);
		};		
