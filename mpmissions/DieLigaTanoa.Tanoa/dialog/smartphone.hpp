class Life_my_smartphone {
	...
	class controls {
		...
		class Notruf : Life_RscButtonMenu {
			...
			onButtonClick = "[]spawn {closeDialog 0; createDialog ""Life_smartphone_notruf"";};";
	...
	class controls {
		...
		class ADACReq : life_RscButtonMenu
		{
			...
			h = (1 / 25);
				...
				class VOICEReq : life_RscButtonMenu
		{
			idc = 888900;
			text = "Voice Notruf";
			colorBackground[] = {0.284, 0.086, 0.086,1.0};
			onButtonClick = "[]spawn {closeDialog 0; [[player,true],""TON_fnc_notwarte"",false,false] call life_fnc_MP; hint ""Bitte warten... Sie werden gleich verbunden !!!""};";
