class Life_impound_menu
{
	...
	movingEnabled = 0;
	enableSimulation = 1;
	onLoad = "ctrlShow [2330,false]; ctrlShow[2806,false]; if (side player != civilian) then {ctrlShow[2805,false];};";
	...
	class controlsBackground
	{
		...
		class SuppGar : life_RscButtonMenu 
		{
			idc = 2806;
			text = "Simsalabim";
			colorBackground[] ={1, 0.15, 0, 0.9};
			onButtonClick = "closeDialog 0;[] call life_fnc_SuppUnimpound;  ";
