class Life_atm_management {
	...
	class controls {
		...
		class TransferButton : life_RscButtonMenu 
		{
			...
			colorBackground[] = {0, 0.25, 0, 0.9};
			onButtonClick = "closeDialog 0; [] call life_fnc_bankTransfer";			
			x = 0.432;
			y = 0.63;
			w = (6 / 40);
			h = (1 / 25);
		...
		class GangDeposit : TransferButton
		{
			...
			colorBackground[] = {0, 0.25, 0, 0.9};
			onButtonClick = "closeDialog 0; [] call life_fnc_gangDeposit";
			y = .69; x = 0.365;
			w = 0.275;
		};
				...
				class GangWithdraw : TransferButton
		{
			...
			colorBackground[] = {0, 0.25, 0, 0.9};
			text = "Vom GANG-KONTO";
			onButtonClick = "closeDialog 0; [] call life_fnc_gangWithdraw";
			y = .74; x = 0.365;
			w = 0.275;
		};
