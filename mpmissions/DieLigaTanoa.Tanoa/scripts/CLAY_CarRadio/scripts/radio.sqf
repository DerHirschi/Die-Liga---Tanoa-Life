...
["kCol"] execVM "scripts\CLAY_CarRadio\scripts\settings.sqf";

CLAY_RadioDisplay = CLAY_RadioDisplay - 1;
["dCol"] execVM "scripts\CLAY_CarRadio\scripts\settings.sqf";
...
["volUp"] execVM "scripts\CLAY_CarRadio\scripts\settings.sqf";
