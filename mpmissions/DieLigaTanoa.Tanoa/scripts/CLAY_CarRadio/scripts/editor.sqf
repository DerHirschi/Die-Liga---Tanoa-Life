...
switch (_this select 0) do
{
	...
	case "create":
	{
		...
		["sourceUp"] execVM "scripts\CLAY_CarRadio\scripts\settings.sqf";
		sleep 0.1;

		closeDialog 0;
		
		profileNamespace setVariable ["Liga_RadioPLS",CLAY_RadioCustomMusic];
		[] execVM "scripts\CLAY_CarRadio\scripts\radio.sqf";
	};
	case "restore":
	{
		lbClear 632;
