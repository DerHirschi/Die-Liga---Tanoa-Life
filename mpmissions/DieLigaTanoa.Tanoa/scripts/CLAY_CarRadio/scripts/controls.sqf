...
switch (_this select 0) do
{
	case "play":
	{
		If (count CLAY_RadioPlayList == 0) exitWith {Hint "Keine Musik in der Playliste";};
		...
		Else
		{
			...
			[_t] execVM "scripts\CLAY_CarRadio\scripts\play.sqf";

			playMusic [_track,CLAY_PausenTimer];
