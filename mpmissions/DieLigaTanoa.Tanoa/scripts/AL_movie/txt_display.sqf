...
// EX: // null = ["GIGI",6,"center","1","#FFF000"] execVM "scripts\AL_movie\txt_display.sqf";
...
if ((!hasInterface) or (introended)) exitWith {};
...
[_title_text_i, 0 , title_pozition_yy, _title_duration,/*fadein*/ 3, 0,_txt_Layer] spawn bis_fnc_dynamicText;