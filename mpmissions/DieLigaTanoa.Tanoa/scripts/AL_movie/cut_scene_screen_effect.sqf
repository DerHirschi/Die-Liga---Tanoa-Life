// by ALIAS
// null = [] execVM "scripts\AL_movie\cut_scene_1.sqf";
...
_camera_shot = [position_1_name, position_2_name, target_name, duration, zoom_level1, zoom_level_2, attached, x_rel_coord, y_rel_coord, z_rel_coord,screen_effect,transition_effect,transition_duration,sound_file_name] execVM "scripts\AL_movie\camera_work.sqf";
...
====================== TEXT ========================================================================================
null = [_title_text,_title_duration,_title_pozition,_text_size,_text_color] execVM "scripts\AL_movie\txt_display.sqf";
...
// text
_txt_1 = ["nightvision",2,"center","3","#FFF000"] execVM "scripts\AL_movie\txt_display.sqf";
// -------------------------------------
_firstshot = [gigi, gigi, target4, 5, 0.7, 0.7, true, 0, 0, 2,"nightvision","none",0,"none"] execVM "scripts\AL_movie\camera_work.sqf";
waitUntil {scriptdone _firstshot};

// text
_txt_2 = ["thermal",2,"center","3","#FFF000"] execVM "scripts\AL_movie\txt_display.sqf";
// -------------------------------------
_secondshot = [gigi, gigi, target5, 5, 0.7, 0.7, true, 0, 0, 2,"thermal","none",0,"none"] execVM "scripts\AL_movie\camera_work.sqf";
waitUntil {scriptdone _secondshot};

// text
_txt_3 = ["blackwhite",2,"center","3","#FFF000"] execVM "scripts\AL_movie\txt_display.sqf";
// -------------------------------------
_thirdshot = [gigi, gigi, target4, 5, 0.7, 0.7, true, 0, 0, 2,"blackwhite","none",0,"none"] execVM "scripts\AL_movie\camera_work.sqf";
waitUntil {scriptdone _thirdshot};

// text
_txt_4 = ["grain",2,"center","3","#FFF000"] execVM "scripts\AL_movie\txt_display.sqf";
// -------------------------------------
_4thshot = [gigi, gigi, target5, 5, 0.7, 0.7, true, 0, 0, 2,"grain","none",0,"none"] execVM "scripts\AL_movie\camera_work.sqf";
waitUntil {scriptdone _4thshot};

// text
_txt_5 = ["blur",2,"center","3","#FFF000"] execVM "scripts\AL_movie\txt_display.sqf";
// -------------------------------------
_5thshot = [gigi, gigi, target4, 5, 0.7, 0.7, true, 0, 0, 2,"blur","none",0,"none"] execVM "scripts\AL_movie\camera_work.sqf";
waitUntil {scriptdone _5thshot};

// text
_txt_6 = ["wet",2,"center","3","#FFF000"] execVM "scripts\AL_movie\txt_display.sqf";
// -------------------------------------
_6thshot = [gigi, gigi, target5, 5, 0.7, 0.7, true, 0, 0, 2,"wet","none",0,"none"] execVM "scripts\AL_movie\camera_work.sqf";
waitUntil {scriptdone _6thshot};

// text
_txt_7 = ["chromatic",2,"center","3","#FFF000"] execVM "scripts\AL_movie\txt_display.sqf";
// -------------------------------------
_7thshot = [gigi, gigi, target4, 5, 0.7, 0.7, true, 0, 0, 2,"chromatic","none",0,"none"] execVM "scripts\AL_movie\camera_work.sqf";
waitUntil {scriptdone _7thshot};

// text
_txt_8 = ["invert",2,"center","3","#FFF000"] execVM "scripts\AL_movie\txt_display.sqf";
// -------------------------------------
_8thshot = [gigi, gigi, target4, 5, 0.7, 0.7, true, 0, 0, 2,"invert","none",0,"none"] execVM "scripts\AL_movie\camera_work.sqf";
