...
_isVehicle = if((_curTarget isKindOf "LandVehicle") OR (_curTarget isKindOf "O_supplyCrate_F") OR (_curTarget isKindOf "Land_WaterTank_F") OR (_curTarget isKindOf "Land_CargoBox_V1_F") OR (_curTarget isKindOf "Land_Pod_Heli_Transport_04_bench_F")  OR (_curTarget isKindOf "Land_Pod_Heli_Transport_04_covered_F")  OR (_curTarget isKindOf "Land_Pod_Heli_Transport_04_fuel_F") OR (_curTarget isKindOf "Land_Pod_Heli_Transport_04_box_F")  OR (_curTarget isKindOf "Land_Pod_Heli_Transport_04_ammo_F") OR (_curTarget isKindOf "Ship") OR (_curTarget isKindOf "Air")) then {true} else {false};
