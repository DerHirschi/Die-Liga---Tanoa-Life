...
if(!((player distance2D [5647.12,11048.9,0] < 60) OR  (player distance ([6849.93,7486.34,0]) < 30) /*OR (player distance (getMarkerPos "Pol_Aut") < 30) OR (player distance (getMarkerPos "police_hq_3") < 30)*/)) then 
{
