...
[2,"STR_House_Raid_NOTF",true,[(_house GVAR "house_owner") select 1]] remoteExec ["life_fnc_broadcast",RCLIENT];

while {true} do
{
	if(animationState player != "AinvPknlMstpSnonWnonDnon_medic_1") then {
		[player,"AinvPknlMstpSnonWnonDnon_medic_1",true] remoteExec ["life_fnc_animSync",RCLIENT];
