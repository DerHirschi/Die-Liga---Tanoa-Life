...
titleText[localize "STR_Jail_Warn1","PLAIN"];
hint localize "STR_Jail_LicenseNOTF1";
...
if(player distance ([12062.2,2449.35,0.00111842]) > 40) then
{
	player setPos ([12062.2,2449.35,0.00111842]);
};
...
[player,_bad] remoteExecCall ["life_fnc_jailSysMed",RSERV];
