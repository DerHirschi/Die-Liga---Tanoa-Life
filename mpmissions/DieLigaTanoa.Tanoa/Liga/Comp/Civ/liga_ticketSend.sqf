...
_control ctrlSetStructuredText parseText format["<t align='center'><t size='.8px'>" +("%1 hat dir eine Rechnung von $%2 gestellt"),_cop getVariable["realname",name _cop],_val];

_Btn1 = _display displayCtrl 2602;
_Btn1 buttonSetAction "[] call ligafn_ticketRec; hint 'Danke fuer die schnelle Bezahlung..';";
[_cop] spawn
{
	_cop = _this select 0;
	...
	{		
		[1,"%1 weigert sich, die Rechnung zu bezahlen.",true,[profileName]] remoteExec ["life_fnc_broadcast",_cop];
	};
};